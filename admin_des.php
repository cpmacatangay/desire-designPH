    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <?php if (count($designer) > 0): ?>
          ...
          <tr>
           <td><?php echo htmlentities($c['des_id']) ?></td>
           <td><?php echo htmlentities($c['des_name']) ?></td>

           <td><?php echo htmlentities($c['des_username']) ?></td>

           <td><?php echo htmlentities($c['des_email']) ?></td>

           <td><?php echo htmlentities($c['des_phone']) ?></td>

           <td><?php echo htmlentities($c['paypal_add']) ?></td>

           <td align="center" >
            <div class="table-responsive">
              <button class="btn btn-light" onclick="document.getElementById('view<?php echo htmlentities($c['des_id'])?>').style.display='block'">
              <i style="font-size: 13px; color: green;" class="fas fa-eye" ></i></button>

               <button class="btn btn-light" onclick="document.getElementById('edit<?php echo htmlentities($c['des_id'])?>').style.display='block'">
              <i style="font-size: 13px; color: blue;" class="fas fa-edit" ></i></button>

                <button class="btn btn-light" onclick="document.getElementById('delete<?php echo htmlentities($c['des_id'])?>').style.display='block'">
