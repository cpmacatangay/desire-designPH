...
registerClient($username,$password,$name,$email,$phone, $company);
...
<head>
 ...
 <body style="background-color: #2b2b2b;">
  <?php include('nav.php') ?>  
               ...
               <div class="container">
            <center>
            <div class="card bg-light" style="width:400px;height: 750px; margin-top: 5em;">
              ...
              <img class="card-img-top" src="logo.png" style="width:50%">
                ...
                <h5 class="card-title">Sign up as Client</h5>
              </br>
                ...
                <input type = "email" class = "form-control" name = "email" placeholder="Company" required>
                </br>
              </br>
